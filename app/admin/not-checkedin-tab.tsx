    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-surface-container-low rounded-lg shadow-inner">
        <div className="flex items-center gap-4">
          <div className="flex items-center bg-white dark:bg-slate-800 rounded-lg px-4 py-2 shadow-sm border border-outline-variant/10">
        ...
        <button 
          ...
          className="flex items-center gap-2 text-primary font-black text-xs uppercase px-4 py-2 hover:bg-primary/5 rounded-lg transition-colors tracking-normal"
        >
          <Download size={16} />
          Xuất danh sách vắng
        </button>
      ...
      {vắngCount === 0 ? (
        <div className="relative bg-surface-container-lowest rounded-xl p-16 flex flex-col items-center justify-center text-center shadow-sm border border-outline-variant/5 min-h-[500px] overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] pointer-events-none">
            <div className="w-[500px] h-[500px] border-4 border-primary rounded-lg animate-pulse"></div>
            <div className="absolute w-[300px] h-[300px] border-4 border-secondary rounded-lg"></div>
            <div className="absolute w-[700px] h-[700px] border border-primary/40 rounded-lg animate-ping"></div>
          </div>
          
          <div className="relative z-10 space-y-8 max-w-md animate-in zoom-in duration-1000">
            <div className="w-32 h-32 bg-green-50 dark:bg-green-900/20 rounded-lg flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-green-500/20 ring-4 ring-green-100/50">
            ...
            <div className="flex items-center justify-center gap-4 pt-4">
              <button className="bg-primary text-on-primary px-10 py-4 rounded-lg font-black text-xs uppercase shadow-xl shadow-primary/20 hover:brightness-110 active:scale-95 transition-all">
                Xem Dashboard
              </button>
              <button 
                onClick={onRefresh}
                className="text-primary font-black px-8 py-4 rounded-lg hover:bg-primary/5 transition-all text-xs uppercase flex items-center gap-2"
              >
          ...
          <div className="absolute top-10 right-10 w-32 h-32 bg-secondary/10 blur-3xl rounded-lg"></div>
          <div className="absolute bottom-10 left-10 w-48 h-48 bg-primary/10 blur-3xl rounded-lg"></div>
        </div>
      ) : (
