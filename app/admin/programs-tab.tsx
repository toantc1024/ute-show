  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <section className="relative h-64 rounded-xl overflow-hidden shadow-xl shadow-primary/10 group">
        ...
        <div className="relative h-full flex flex-col md:flex-row items-center px-12 justify-between gap-6 py-6 text-center md:text-left">
          <div className="max-w-xl">
            <span className="inline-block px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-white text-[10px] font-bold mb-4 tracking-widest uppercase">REAL-TIME MONITOR</span>
            <h3 className="text-4xl font-extrabold text-white mb-2 leading-tight tracking-tight uppercase">Hoạt động đang diễn ra</h3>
          ...
          <div className="flex gap-4 sm:gap-6">
            <div className="glass-card p-6 rounded-lg text-primary text-center min-w-[140px] shadow-lg border border-white/20">
              <p className="text-xs font-bold opacity-70 uppercase tracking-tighter mb-1">Tổng sự kiện</p>
            ...
            <div className="glass-card p-6 rounded-lg text-secondary text-center min-w-[140px] shadow-lg border border-white/20">
              <p className="text-xs font-bold opacity-70 uppercase tracking-tighter mb-1">Đang chạy</p>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h4 className="text-xl font-bold text-on-surface uppercase tracking-tight">Danh sách sự kiện</h4>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
          ...
          <Card className="relative w-full max-w-2xl bg-white shadow-2xl rounded-2xl overflow-hidden border-none animate-in zoom-in-95 duration-200">
            <div className="p-6 border-b border-outline-variant/10 flex items-center justify-between bg-surface-container-low">
              <h3 className="text-lg font-black tracking-tight uppercase">{editingId ? "Chỉnh sửa" : "Thêm mới"} chương trình</h3>
              <button 
            ...
            <form onSubmit={handleCreate} className="p-8 space-y-6">
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label className="text-xs font-black uppercase tracking-widest text-on-surface-variant">Tên chương trình</Label>
                  <Input 
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                   <div className="space-y-2">
                    <Label className="text-xs font-black uppercase tracking-widest text-on-surface-variant">Ngày tổ chức</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs font-black uppercase tracking-widest text-on-surface-variant">Bắt đầu checkin</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs font-black uppercase tracking-widest text-on-surface-variant">Kết thúc checkin</Label>
              ...
              <Button type="submit" disabled={loading} className="w-full h-14 bg-primary hover:bg-primary-container text-white font-black text-base shadow-xl shadow-primary/20 rounded-xl transition-all active:scale-95 uppercase tracking-widest">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {events.map((event) => (
          ...
          >
            ...
            <h5 className={cn("text-lg font-bold text-on-surface mb-2 tracking-tight group-hover:text-primary transition-colors", event.is_active ? "text-secondary" : "")}>
              {event.title}
            </h5>
            ...
            <div className="space-y-3 mt-4 flex-1">
              ...
              <div className="flex items-center gap-3 text-on-surface-variant/80">
                ...
                <span className="text-xs font-bold uppercase tracking-tight">Hội trường A (Mặc định)</span>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-surface-container-low flex justify-between items-center bg-transparent">
              ...
              <span className={cn("text-[10px] font-black uppercase tracking-widest", event.is_active ? "text-secondary animate-pulse" : "text-primary")}>
        ...
        {events.length === 0 && (
          <div className="col-span-full py-20 text-center">
            <p className="text-slate-400 font-bold uppercase tracking-widest text-sm">Chưa có chương trình nào được tạo.</p>
          </div>
        )}
      </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
        <div className="col-span-1 md:col-span-2 glass-card rounded-lg p-8 flex items-center gap-8 shadow-sm border border-white/50">
          <div className="w-24 h-24 rounded-full border-[6px] border-secondary flex flex-col items-center justify-center bg-white shadow-inner">
            ...
            <span className="text-[8px] font-black text-slate-400 uppercase tracking-tighter">AVG RATE</span>
          </div>
          <div>
            <h6 className="text-lg font-bold text-primary mb-1 uppercase tracking-tight">Hiệu suất tham gia trung bình</h6>
        ...
        <div className="bg-primary text-white rounded-lg p-8 shadow-xl shadow-primary/20 relative overflow-hidden group border border-primary-container">
          ...
          <h6 className="text-lg font-bold mb-2 uppercase tracking-tight">Tạo báo cáo nhanh</h6>
          ...
          <button className="w-full bg-white text-primary font-black py-3 rounded-full text-xs uppercase tracking-widest shadow-lg active:scale-95 transition-all">
            Xuất File .CSV
          </button>
        </div>
      </section>
