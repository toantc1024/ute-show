    ...
    <main className="relative flex h-screen w-screen flex-col overflow-hidden bg-[#f0f4f8] text-slate-900 selection:bg-blue-200">
      ...
      <AnimatedGridPattern
        ...
        className={cn(
          ...
          "inset-0 h-full w-full skew-y-12 fill-primary/5 stroke-primary/5"
        )}
      />
      ...
      <div className="relative isolate z-10 flex h-full w-full flex-col justify-between gap-6 pt-6 pb-6 md:gap-10 md:pt-10 md:pb-10">
        ...
        <section className="mx-auto flex min-h-0 w-full max-w-[1920px] flex-1 flex-col px-4 md:px-8">
          <div className="border-border mb-1 flex shrink-0 items-center justify-center rounded-xl border-primary/70 p-2 shadow-lg shadow-primary/10 md:mb-1">
            <h2 className="!text-xl font-bold tracking-normal text-[var(--color-primary)] uppercase [text-shadow:0_1px_8px_rgba(255,255,255,0.7)] md:text-3xl lg:text-4xl px-4 text-center">
