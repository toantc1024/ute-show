...
export function AdminAuthGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="bg-[#0f172a] font-body text-slate-200 min-h-screen w-full flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#0f172a] to-[#1e293b]">
      {/* Animated Orbs */}
        ...
        <div className="bg-white/5 backdrop-blur-[40px] border border-white/10 rounded-2xl shadow-2xl relative overflow-hidden">
          ...
          <div className="w-full py-12 px-10">
            ...
            <div className="flex flex-col items-center mb-10 text-center">
              ...
              <p className="text-slate-400 text-sm mt-2 font-medium">Hệ thống điểm danh công nghệ cao</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input 
                    className={`w-full pl-11 pr-12 py-3.5 bg-slate-900/50 border ${error ? 'border-red-500/50 focus:ring-red-500/50' : 'border-white/10 focus:border-primary/50 focus:ring-primary/50'} rounded-lg focus:ring-2 text-white placeholder:text-slate-600 transition-all outline-none`}
                    id="password" 
                    name="password" 
                    placeholder="••••••••" 
                ...
                {error && (
                  <p className="text-[10px] font-bold uppercase tracking-widest text-red-500 px-1 animate-pulse">
      ...
      {/* Footer */}
      <footer className="w-full mt-auto py-8 px-12 bg-white/5 backdrop-blur-[40px] border-t border-white/10 z-10">
