          ...
          {filteredCheckins.length === 0 ? (
            ...
            filteredCheckins.map((item) => (
              <motion.div 
                ...
                key={item.id} 
                className="flex items-center justify-between p-4 rounded-2xl bg-surface-container-low/50 hover:bg-surface-container-low transition-all group border border-transparent hover:border-outline-variant/10 shadow-sm"
              >
